...
namespace ChancelleryShop.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ProductsController(ChancelleryContext context)
        {
            _context = context;
        }
        ...
        {
            var chancelleryContext = _context.Products.Include(p => p.Category);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductId,ProductName,Price,CategoryId,ProductImage,ProductDescription")] Product product)
        {
